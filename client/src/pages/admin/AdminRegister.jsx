...
export default function AdminRegister() {
  ...
  const submitHandler = async (e) => {
    ...
    setErrorMsg('');
    try {
      const res = await register({ email, password, adminSecret }).unwrap();
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#04060a] px-6 relative overflow-hidden py-12">
      {/* Background glow */}
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-10">
          ...
          <p className="text-brand-yellow text-sm font-bold tracking-widest uppercase">Admin Registration</p>
        </div>
        ...
        <div className="bg-[#111317]/80 backdrop-blur-xl border border-gray-800 rounded-2xl p-8 shadow-[0_15px_40px_rgba(0,0,0,0.5)]">
          ...
          <form onSubmit={submitHandler} className="space-y-5">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-400 mb-1.5">Admin Secret Key</label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-400 text-sm">
              ...
              <Link to="/admin/login" className="text-brand-yellow hover:text-yellow-400 font-medium transition-colors">
                Sign In
              </Link>
            </p>
          </div>
