...
export default function PlacementsHero() {
  ...
  return (
    <div className="px-6 lg:px-12 max-w-[1400px] mx-auto pt-5 relative z-10 w-full flex flex-col md:flex-row items-center justify-between gap-12 lg:gap-16">
      ...
      <div className="w-full md:w-1/2 flex flex-col text-left">
        ...
        <h1 className="text-[38px] md:text-5xl lg:text-[56px] font-extrabold leading-[1.1] mb-6 tracking-tight text-white drop-shadow-md">
          Your Success,<br />
          <span className="text-brand-yellow drop-shadow-[0_0_15px_rgba(248,180,23,0.2)]">Our Commitment.</span>
        </h1>

        {/* Paragraph */}
        <p className="text-gray-300 text-[15px] md:text-[16px] max-w-lg leading-relaxed mb-10 drop-shadow-sm font-medium">
          At Prime Impact, we don't just train you—we prepare you for real-world success. Our placement-focused approach ensures you get the right opportunities with top companies.
        </p>
        ...
        <div className="flex flex-wrap items-center gap-5">
          <button 
            onClick={() => {
              const el = document.getElementById("placement-stories");
          ...
          >
            View Placement Stories <ArrowRight className="w-5 h-5" />
          </button>
          <button
          ...
          >
            Talk to Placement Team <div className="bg-brand-yellow rounded-full p-1.5 group-hover:scale-110 transition-transform"><ArrowRight className="w-3.5 h-3.5 fill-black text-black translate-x-[1px]" /></div>
          </button>
        </div>
      </div>
        ...
        <div className="relative">
          ...
          <div className="absolute -bottom-6 left-1/2 -translate-x-1/2 z-30 bg-[#111317]/90 backdrop-blur-xl border border-gray-700 p-4 rounded-xl shadow-[0_15px_40px_rgba(0,0,0,0.8)] flex items-center gap-4 animate-bounce-slow whitespace-nowrap">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-gray-400 text-xs font-medium uppercase tracking-wide">Students Placed</span>
            </div>
          </div>
        </div>
      </div>
