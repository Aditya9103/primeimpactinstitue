...
export default function BookDemoCTA() {
  ...
  return (
    <div className="px-6 lg:px-12 max-w-[1400px] mx-auto bg-transparent relative z-10">
      <div className="relative rounded-xl overflow-hidden p-8 md:px-10 md:py-7 flex flex-col md:flex-row items-center justify-between gap-8 border border-brand-yellow/20 shadow-[0_0_30px_rgba(248,180,23,0.05)] bg-[#04060a]/80 backdrop-blur-sm">
        ...
        <div className="relative z-10 flex flex-col sm:flex-row items-center sm:items-start md:items-center gap-6 md:gap-8 w-full md:w-auto">
          ...
          <div className="text-center sm:text-left">
            <h3 className="text-2xl md:text-3xl text-white font-extrabold mb-3 tracking-tight">Limited Seats Per Session!</h3>
            <p className="text-gray-200 drop-shadow-sm text-[15px] leading-relaxed max-w-md">
              Hurry up! Book your free demo class now and take the first step towards your successful career in digital marketing.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
          ...
          >
            Contact Admissions <Phone className="w-4 h-4 text-brand-yellow/70" />
          </button>
        </div>
      </div>
    </div>
